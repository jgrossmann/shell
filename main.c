 ...
 * I did not have enough time to finish step 2. I got it working partially.
	Step 1 is in its entirety in the file "part1.c" and it even has **path variable capacity.** 
	"main.c" is very glitchy in parallel mode and possibly sequential because i tried to run
	background processes.
	However, part1.c works fine up until you want the background processes and step 2 commands.
